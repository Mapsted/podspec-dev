Pod::Spec.new do |s|  
    ...
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-map', '4.6.34'
    s.dependency 'mapsted-sdk-loc-marketing', '4.6.34'
    s.dependency 'mapsted-sdk-alerts', '4.6.34'
    s.dependency 'mapsted-sdk-components', '4.6.34'
end  
