Pod::Spec.new do |s|  
    ...
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-map', '5.1.3'
    s.dependency 'mapsted-sdk-loc-marketing', '5.1.3'
    s.dependency 'mapsted-sdk-alerts', '5.1.3'
    s.dependency 'mapsted-sdk-components', '5.1.3'
end  
